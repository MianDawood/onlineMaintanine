...
// Keep Add Modal URL select2 open on selection
$('#add_url').on('select2:select select2:unselect', function (e) {
  let select = $(this);
  setTimeout(() => select.select2('open'), 0);
});

// Keep QS Modal URL select2 open on selection
$('#qs_url').on('select2:select select2:unselect', function (e) {
  let select = $(this);
  setTimeout(() => select.select2('open'), 0);
});
