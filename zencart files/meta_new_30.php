                ...
                elseif (
                  ...
                  (in_array($column_name, ['textbox1', 'textbox2', 'textbox3', 'textbox4', 'textbox5','qsTextbox1','qsTextbox2','qsTextbox3','qsTextbox4','qsTextbox5']) && isset($form_data['include_textboxes']))
                    ...
                    if (trim($cell) != '') {
                        ...
                        // Add button
                        echo ' <button class="btn btn-xs btn-outline-success" style="padding:2px 5px; font-size:10px;" title="Add Template to this Url"  data-toggle="tooltip" data-bs-placement="left" title="Click here to Add Template for this url from the list"
