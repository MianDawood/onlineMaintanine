...
<div class="modal fade" id="templateEditModal" tabindex="-1" role="dialog" aria-labelledby="templateEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
<?php echo zen_draw_pull_down_menu('modal_template_list', $za_template_names, '', 'id="modal_template_list" class="form-control"'); ?>
</div>
...
<button class="btn btn-sm btn-success mb-2" onclick="viewSelectedJS()">Backup</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <button class="btn btn-sm btn-secondary" onclick="showTemplateJS()">Backup</button>
        </div>
...
$('#templateEditModal').on('shown.bs.modal', function () {
  const $select = $('#modal_template_list');
