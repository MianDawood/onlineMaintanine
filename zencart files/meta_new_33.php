...
.tooltip.top .tooltip-arrow {
  border-top-color: rgba(48, 48, 48, 0.95) !important;
}

.tooltip.bottom .tooltip-arrow {
  border-bottom-color: rgba(48, 48, 48, 0.95) !important;
}

.tooltip.left .tooltip-arrow {
  border-left-color: rgba(48, 48, 48, 0.95) !important;
}

.tooltip.right .tooltip-arrow {
  border-right-color: rgba(48, 48, 48, 0.95) !important;
}
...
.select2-controls button {
  ...
  <div class="text-right">
    ...
    <button class="btn btn-info"
            data-toggle="modal"
            data-target="#addQsRecordModal"
            title="Click to add a new QS URL"
            data-placement="top">
      ➕ Add QS URL
    </button>
  </div>
        ...
        <label for="url" class="control-label col-sm-3">Search for URL</label>
          <div class="col-sm-9 col-md-6"><?php echo zen_draw_input_field('url', $q_all, 'id="url" class="form-control" size="40" placeholder="Enter Url you want to search" data-toggle="tooltip" title="Enter Url you want to Search" data-placement="right"'); ?></div>
        </div>
    ...
    // Prepend "Search in All Domains" option
    $za_lookup_domain = array(array('id' => 'all', 'text' => 'All Domains'));
    ...
    <div class="col-sm-9 col-md-6" data-toggle="tooltip" title="Select Desired Domain you want to search URL" data-placement="right">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-md-6" data-toggle="tooltip" title="Select Desired Table you want to search URL" data-placement="right">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-md-6"data-toggle="tooltip" title="check if you want to display Textfields record with URL" data-placement="right">
            <div class="checkbox">
     ...
     <input type="checkbox" name="include_textboxes" id="include_textboxes"  <?php echo (isset($form_data['include_textboxes']) ? 'checked' : ''); ?> >
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-md-6" data-toggle="tooltip" title="Check if you want to display templates record with URL" data-placement="right">
            <div class="checkbox">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 col-md-6" data-toggle="tooltip" title="Check if you want to Display Meta information with URL" data-placement="right">
            <div class="checkbox">
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="form_submit" value="1">
            <button type="submit" class="btn btn-primary" data-toggle="tooltip"  title="Click to Search display item according to selection"
            data-placement="top"><?php echo TEXT_BUTTON_SEARCH; ?></button>
            <a href="meta_new.php?clear=1" class="btn btn-warning" data-toggle="tooltip"  title="Click here to reset/remove existing Search "
            data-placement="top">Clear Search</a>
          </div>
        </div>
        <?php echo '</form>'; ?>
...
<div class="text-left" style="margin-bottom: 10px;">
  <form method="get" action="meta_new.php" class="form-inline" style="display: inline-block;">
    ...
    <select name="per_page" id="per_page" class="form-control input-sm" onchange="this.form.submit()" data-toggle="tooltip" title="Select Desired number of records to display on a page" data-placement="right">
      <?php
...
<div class="col-sm-3 col-lg-3 text-right">
    <label>Search:
    <input type="text" id="tableSearch" class="form-control" placeholder="Search in this page..." data-toggle="tooltip" title="Search URL in this page" data-placement="left">
            ...
            <td id="template_cell_<?php echo htmlspecialchars($row['id']) . '_' . htmlspecialchars($column_name); ?>">
                ...
                if (($column_name === 'cookiecutterqs_temp' || $column_name === 'qs_cookiecutter_name') && isset($form_data['include_meta'])) {
                  ...
                  if (trim($cell) != '') {
                      ...
                      echo ' <button class="btn btn-xs btn-outline-primary" style="padding:2px 5px; font-size:10px;" title="Click here to change Cookiecutterqs Template for this url" data-toggle="tooltip" data-placement="right"
                          onclick="openCookieQSModal(\'edit\', \'' . htmlspecialchars($columnToPass) . '\', \'' . htmlspecialchars($row['domain']) . '\', \'' . $valueToPass . '\', \'' . $row['id'] . '\')">✏️</button>';
              
                      // Delete Button
                      echo ' <button class="btn btn-xs btn-outline-danger" style="padding:2px 5px; font-size:10px;" title="Click here to remove Cookiecutterqs Template from this url"  data-toggle="tooltip" data-placement="right"
                      ...
                      echo ' <button class="btn btn-xs btn-outline-success" style="padding:2px 5px; font-size:10px;" title="Click here to Add Cookiecutterqs Template to this url"  data-toggle="tooltip" data-placement="right"
                ...
                elseif (
                  ...
                  (in_array($column_name, ['textbox1', 'textbox2', 'textbox3', 'textbox4', 'textbox5','qsTextbox1','qsTextbox2','qsTextbox3','qsTextbox4','qsTextbox5']) && isset($form_data['include_textboxes']))
                    ...
                    if (trim($cell) != '') {
                        ...
                        echo ' <button class="btn btn-xs btn-outline-primary" style="padding:2px 5px; font-size:10px;" title="Click here to Change Template for this url"  data-toggle="tooltip" data-placement="right"
                            ...
                            echo ' <button class="btn btn-xs btn-outline-primary" style="padding:2px 5px; font-size:10px;" title="Click here to edit and update current Template"  data-toggle="tooltip" data-placement="right"
                            onclick="edit_each_temp(\'' . htmlspecialchars($column_name) . '\', \'' . htmlspecialchars($row['domain']) . '\', \'' . htmlspecialchars($cell) . '\', \'' . $row['id'] . '\')">👁️</button>';
                    
                            echo ' <button class="btn btn-xs btn-outline-primary" style="padding:2px 5px; font-size:10px;" title="Click here to Backup current Template in folder"  data-toggle="tooltip" data-placement="right"
                        ...
                        // Delete button
                        echo ' <button class="btn btn-xs btn-outline-danger" style="padding:2px 5px; font-size:10px;" title="Delete Template"  data-toggle="Click here to remove this Template from this url" data-placement="right"
                            onclick="deleteTemplateField(\'' . htmlspecialchars($column_name) . '\', \'' . htmlspecialchars($row['domain']) . '\', \'' . $row['id'] . '\')">🗑️</button>';
                    } else {
                        // Add button
                        echo ' <button class="btn btn-xs btn-outline-success" style="padding:2px 5px; font-size:10px;" title="Add Template to this Url"  data-toggle="tooltip" data-placement="right" title="Click here to Add Template for this url from the list"
                    ...
                    if (trim($cell) != '') {
                        ...
                        echo ' <button class="btn btn-xs btn-outline-primary" style="padding:2px 5px; font-size:10px;" title="Click here to add Template to this url"  data-toggle="tooltip" data-placement="right"
                        ...
                        // Clear button
                        echo ' <button class="btn btn-xs btn-outline-danger" style="padding:2px 5px; font-size:10px;" title="Click here to Remove Meta Title or desc for this url"  data-toggle="tooltip" data-placement="right"
                            onclick="clearMetaField(\'' . htmlspecialchars($column_name) . '\', \'' . htmlspecialchars($row['domain']) . '\', \'' . $row['id'] . '\')">🗑️</button>';
                    } else {
                        // Add button
                        echo ' <button class="btn btn-xs btn-outline-success" style="padding:2px 5px; font-size:10px;" title="Click here to add Meta title or desc to this url"  data-toggle="tooltip" data-placement="right"
...
<div class="col-sm-3 col-lg-3 text-left">
    <form method="get" action="meta_new.php" class="form-inline" style="margin-bottom: 10px;">
      ...
      <select name="page" id="jump_page" class="form-control input-sm" onchange="this.form.submit()" style="margin-left: 5px;" data-toggle="tooltip" title="Jump directly to a page no" data-placement="right">
    ...
    <form id="cookieqs_form" onsubmit="return saveCookieQSValue();">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary"  data-toggle="tooltip" title="Click Here to Save the selected QS Template with the URL" data-placement="right">Save</button>
        </div>
      </div>
    </form>
  </div>
...
<div class="modal fade" id="templateEditModal" tabindex="-1" role="dialog" aria-labelledby="templateEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
  <!-- Template Dropdown -->
  <div class="form-group col-md-4" data-toggle="tooltip" title="Change template" data-placement="left">
  ...
  <!-- CSS File Dropdown -->
  <div class="form-group col-md-4" data-toggle="tooltip" title="Change CSS" data-placement="left">
  ...
  <!-- JS File Dropdown -->
  <div class="form-group col-md-4" data-toggle="tooltip" title="Change JS" data-placement="left">
    ...
    <select id="modal_js_list" class="form-control select2">
      <option value="">Loading JS files...</option>
        ...
        <!-- Action Buttons -->
        <div class="mb-2">
          <button class="btn btn-sm btn-primary" onclick="viewSelectedTemplate()" data-toggle="tooltip" title="Click here to View Template" data-placement="right">View Template</button>
          <button class="btn btn-sm btn-info" onclick="viewSelectedCSS()" data-toggle="tooltip" title="Click here to View CSS but First Click to View Template Once to Load Css" data-placement="right">View CSS</button>
          <button class="btn btn-sm btn-warning" onclick="viewSelectedJS()" data-toggle="tooltip" title="Click here to View JS but First Click to View Template Once to Load JS" data-placement="right">View JS</button>
        </div>
        ...
        <div id="template_view_section" style="border:1px solid #ccc; padding:10px; display:none;">
          <div id="template_html_wrapper" style="display: none;">
            <h6 >Template HTML</h6>
            <div id="template_html_editor" data-toggle="tooltip" title="Click Here to View and Change Template HTML Code" data-placement="bottom"></div>
          </div>

          <div id="template_css_wrapper" style="display: none;">
            <h6>Edit CSS</h6>
            <div id="template_css_editor" data-toggle="tooltip" title="Click Here to View and change CSS code" data-placement="bottom"></div>
          </div>

          <div id="template_js_wrapper" style="display: none;">
            <h6>Edit JavaScript</h6>
            <div id="template_js_editor" data-toggle="tooltip" title="Click Here to View and Change JS code" data-placement="bottom"></div>
          </div>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn btn-success" onclick="saveTemplateSelection()" data-toggle="tooltip" title="Click Here to Save the selected Template with the URL" data-placement="right">Save</button>
...
<div class="modal fade" id="update_template_css_modal" tabindex="-1" role="dialog" aria-labelledby="templateEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <button class="btn btn-sm btn-secondary" onclick="showTemplateHTML()" data-toggle="tooltip" title="Click Here to View and change Template HTML code" data-placement="bottom">View HTML</button>
          <button class="btn btn-sm btn-secondary" onclick="showTemplateCSS()" data-toggle="tooltip" title="Click Here to View and change Template CSS code" data-placement="bottom">View CSS</button>
          <button class="btn btn-sm btn-secondary" onclick="showTemplateJS()" data-toggle="tooltip" title="Click Here to View and change Template JS code" data-placement="bottom">View JS</button>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary" onclick="saveUpdatedTemplateFile()" data-toggle="tooltip" title="Click Here to Save change in The Template files" data-placement="bottom">Save Changes</button>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="modal-body">
        <form id="addRecordForm">
          <div class="row">
            ...
            <div class="col-md-8">
             <div class="select2-controls">
              <button type="button" id="addUrlSelectAllBtn">Select All Visible</button>
              <button type="button" id="addUrlClearAllBtn">Clear All</button>
            </div>
    ...
    <div class="modal-content position-relative">
      ...
      <div class="modal-body">
        <form id="addQsRecordForm">
          ...
          <div class="form-group">
            <label>Domain</label>
            <select id="add_qs_domain" name="domain" class="form-control select2-add-record" required></select>
          </div>

          <div class="form-group">
            <label>QS URL</label>
            <div class="select2-controls">
            <button type="button" id="qsUrlSelectAllBtn">Select All Visible</button>
            <button type="button" id="qsUrlClearAllBtn">Clear All</button>
          </div>
