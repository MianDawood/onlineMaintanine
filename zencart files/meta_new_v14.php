  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button class="btn btn-sm btn-secondary mb-2" onclick="viewSelectedCSS()">View CSS</button>
        <button class="btn btn-sm btn-secondary mb-2" onclick="viewSelectedJS()">View JS</button>
